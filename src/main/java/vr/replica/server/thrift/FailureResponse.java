...
public class FailureResponse implements org.apache.thrift.TBase<FailureResponse, FailureResponse._Fields>, java.io.Serializable, Cloneable, Comparable<FailureResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("FailureResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new FailureResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new FailureResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(FailureResponse.class, metaDataMap);
  }
   ...
   */
  public FailureResponse(FailureResponse other) {
  ...
  public FailureResponse deepCopy() {
  ...
  public FailureResponse setRequestNumber(long requestNumber) {
    this.requestNumber = requestNumber;
    setRequestNumberIsSet(true);
    return this;
  }
  ...
  public FailureResponse setResponseString(String responseString) {
    this.responseString = responseString;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof FailureResponse)
      return this.equals((FailureResponse)that);
    return false;
  }

  public boolean equals(FailureResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(FailureResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("FailureResponse(");
    boolean first = true;
  ...
  private static class FailureResponseStandardSchemeFactory implements SchemeFactory {
    public FailureResponseStandardScheme getScheme() {
      return new FailureResponseStandardScheme();
    }
  }

  private static class FailureResponseStandardScheme extends StandardScheme<FailureResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FailureResponse struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FailureResponse struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class FailureResponseTupleSchemeFactory implements SchemeFactory {
    public FailureResponseTupleScheme getScheme() {
      return new FailureResponseTupleScheme();
    }
  }

  private static class FailureResponseTupleScheme extends TupleScheme<FailureResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FailureResponse struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FailureResponse struct) throws org.apache.thrift.TException {
