...
public class SuccessResponse implements org.apache.thrift.TBase<SuccessResponse, SuccessResponse._Fields>, java.io.Serializable, Cloneable, Comparable<SuccessResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SuccessResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new SuccessResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SuccessResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SuccessResponse.class, metaDataMap);
  }
   ...
   */
  public SuccessResponse(SuccessResponse other) {
  ...
  public SuccessResponse deepCopy() {
  ...
  public SuccessResponse setRequestNumber(long requestNumber) {
    this.requestNumber = requestNumber;
    setRequestNumberIsSet(true);
    return this;
  }
  ...
  public SuccessResponse setResponseString(String responseString) {
    this.responseString = responseString;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SuccessResponse)
      return this.equals((SuccessResponse)that);
    return false;
  }

  public boolean equals(SuccessResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(SuccessResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SuccessResponse(");
    boolean first = true;
  ...
  private static class SuccessResponseStandardSchemeFactory implements SchemeFactory {
    public SuccessResponseStandardScheme getScheme() {
      return new SuccessResponseStandardScheme();
    }
  }

  private static class SuccessResponseStandardScheme extends StandardScheme<SuccessResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SuccessResponse struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SuccessResponse struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class SuccessResponseTupleSchemeFactory implements SchemeFactory {
    public SuccessResponseTupleScheme getScheme() {
      return new SuccessResponseTupleScheme();
    }
  }

  private static class SuccessResponseTupleScheme extends TupleScheme<SuccessResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SuccessResponse struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SuccessResponse struct) throws org.apache.thrift.TException {
