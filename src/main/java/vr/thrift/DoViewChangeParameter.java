...
public class DoViewChangeParameter implements org.apache.thrift.TBase<DoViewChangeParameter, DoViewChangeParameter._Fields>, java.io.Serializable, Cloneable, Comparable<DoViewChangeParameter> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DoViewChangeParameter");
  ...
  private static final org.apache.thrift.protocol.TField RETRY_COUNT_FIELD_DESC = new org.apache.thrift.protocol.TField("retryCount", org.apache.thrift.protocol.TType.I32, (short)8);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new DoViewChangeParameterStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DoViewChangeParameterTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    RETRY_COUNT((short)8, "retryCount");
  ...
  private static final int __RETRYCOUNT_ISSET_ID = 6;
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DoViewChangeParameter.class, metaDataMap);
  }

  public DoViewChangeParameter() {
    this.retryCount = 0;
   ...
   */
  public DoViewChangeParameter(DoViewChangeParameter other) {
  ...
  public DoViewChangeParameter deepCopy() {
    return new DoViewChangeParameter(this);
  }
  ...
  public DoViewChangeParameter setNewViewNumber(int newViewNumber) {
    this.newViewNumber = newViewNumber;
    setNewViewNumberIsSet(true);
    return this;
  }
  ...
  public DoViewChangeParameter setLogs(Map<Integer,Log> logs) {
    this.logs = logs;
    return this;
  }
  ...
  public DoViewChangeParameter setOldViewNumber(int oldViewNumber) {
    this.oldViewNumber = oldViewNumber;
    setOldViewNumberIsSet(true);
    return this;
  }
  ...
  public DoViewChangeParameter setCheckPoint(int checkPoint) {
    this.checkPoint = checkPoint;
    setCheckPointIsSet(true);
    return this;
  }
  ...
  public DoViewChangeParameter setOpNumber(int opNumber) {
    this.opNumber = opNumber;
    setOpNumberIsSet(true);
    return this;
  }
  ...
  public DoViewChangeParameter setCommitNumber(int commitNumber) {
    this.commitNumber = commitNumber;
    setCommitNumberIsSet(true);
    return this;
  }
  ...
  public DoViewChangeParameter setReplicaNumber(int replicaNumber) {
    this.replicaNumber = replicaNumber;
    setReplicaNumberIsSet(true);
    return this;
  }
  ...
  public DoViewChangeParameter setRetryCount(int retryCount) {
    this.retryCount = retryCount;
    setRetryCountIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DoViewChangeParameter)
      return this.equals((DoViewChangeParameter)that);
    return false;
  }

  public boolean equals(DoViewChangeParameter that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(DoViewChangeParameter other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DoViewChangeParameter(");
    boolean first = true;
  ...
  private static class DoViewChangeParameterStandardSchemeFactory implements SchemeFactory {
    public DoViewChangeParameterStandardScheme getScheme() {
      return new DoViewChangeParameterStandardScheme();
    }
  }

  private static class DoViewChangeParameterStandardScheme extends StandardScheme<DoViewChangeParameter> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DoViewChangeParameter struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.logs = new HashMap<Integer,Log>(2*_map8.size);
                int _key9;
                Log _val10;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DoViewChangeParameter struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.logs != null) {
        oprot.writeFieldBegin(LOGS_FIELD_DESC);
        {
          ...
          for (Map.Entry<Integer, Log> _iter12 : struct.logs.entrySet())
          {
  ...
  private static class DoViewChangeParameterTupleSchemeFactory implements SchemeFactory {
    public DoViewChangeParameterTupleScheme getScheme() {
      return new DoViewChangeParameterTupleScheme();
    }
  }

  private static class DoViewChangeParameterTupleScheme extends TupleScheme<DoViewChangeParameter> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, DoViewChangeParameter struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetLogs()) {
        {
          ...
          for (Map.Entry<Integer, Log> _iter13 : struct.logs.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, DoViewChangeParameter struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.logs = new HashMap<Integer,Log>(2*_map14.size);
          int _key15;
          Log _val16;
