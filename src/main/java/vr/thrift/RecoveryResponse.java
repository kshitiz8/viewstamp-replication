...
public class RecoveryResponse implements org.apache.thrift.TBase<RecoveryResponse, RecoveryResponse._Fields>, java.io.Serializable, Cloneable, Comparable<RecoveryResponse> {
  ...
  public RecoveryResponse setLog(List<Log> log) {
    this.log = log;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.log = new ArrayList<Log>(_list0.size);
                Log _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new Log();
                  _elem1.read(iprot);
                  struct.log.add(_elem1);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.log = new ArrayList<Log>(_list5.size);
          Log _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = new Log();
            _elem6.read(iprot);
            struct.log.add(_elem6);
          }
        }
        struct.setLogIsSet(true);
      }
