...
public class RequestSuccess implements org.apache.thrift.TBase<RequestSuccess, RequestSuccess._Fields>, java.io.Serializable, Cloneable, Comparable<RequestSuccess> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RequestSuccess");
  ...
  static {
    schemes.put(StandardScheme.class, new RequestSuccessStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RequestSuccessTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RequestSuccess.class, metaDataMap);
  }
   ...
   */
  public RequestSuccess(RequestSuccess other) {
  ...
  public RequestSuccess deepCopy() {
    return new RequestSuccess(this);
  }
  ...
  public RequestSuccess setRequestNumber(long requestNumber) {
    this.requestNumber = requestNumber;
    setRequestNumberIsSet(true);
    return this;
  }
  ...
  public RequestSuccess setResponseString(String responseString) {
    this.responseString = responseString;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RequestSuccess)
      return this.equals((RequestSuccess)that);
    return false;
  }

  public boolean equals(RequestSuccess that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(RequestSuccess other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RequestSuccess(");
    boolean first = true;
  ...
  private static class RequestSuccessStandardSchemeFactory implements SchemeFactory {
    public RequestSuccessStandardScheme getScheme() {
      return new RequestSuccessStandardScheme();
    }
  }

  private static class RequestSuccessStandardScheme extends StandardScheme<RequestSuccess> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RequestSuccess struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RequestSuccess struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class RequestSuccessTupleSchemeFactory implements SchemeFactory {
    public RequestSuccessTupleScheme getScheme() {
      return new RequestSuccessTupleScheme();
    }
  }

  private static class RequestSuccessTupleScheme extends TupleScheme<RequestSuccess> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RequestSuccess struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RequestSuccess struct) throws org.apache.thrift.TException {
